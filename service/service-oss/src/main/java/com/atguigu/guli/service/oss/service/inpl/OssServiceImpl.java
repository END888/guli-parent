package com.atguigu.guli.service.oss.service.inpl;
...
public class OssServiceImpl implements OssService {
    ...
    public String upload(MultipartFile file, String module) {
        ...
        OSS ossClient = new OSSClientBuilder().build(ossProperties.getEndpoint(),
                ossProperties.getKeyId(), ossProperties.getKeySecret());
        try {
            ...
            ossProperties.setEndpoint(ossProperties.getEndpoint().replace("https://", ""));
            String path = "https://" + ossProperties.getBucketName() + "." + ossProperties.getEndpoint() + "/" + objectName;
            log.info("BucketName: {}", ossProperties.getBucketName());
            log.info("Endpoint: {}", ossProperties.getEndpoint());
            log.info("path: {}", path);
            return path;
        } catch (Exception e) {
